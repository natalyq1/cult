...
const ServiceArtist = () => {
    return (
      <fragment>
        ...
        <h3 className="title-p">Servicios ofrecidos</h3>
        ...
        <article className="cards-container-p">
          <section className="card-product">
            ...
            <article className="card-p-info">
              ...
              <p>
                El hip-hop es mi lienzo, y mis movimientos son la pintura.
                Explora la energía y la pasión de la cultura urbana mientras te
                invito a un mundo de ritmo y estilo. ¡Prepárate para el
                espectáculo!
              </p>
