  ...
  return (
    <fragment>
      <article className="main-section">
        <h3>
          Explora el talento bogotano, encuentra artistas a tu medida, solicita
      ...
      <article className="cards-container">
        ...
        <section className="card card4">
          ...
          <div className="content">
            <p>
              A través de los lentes, explora un universo visual donde cada
              imagen es una historia única y emocionante.{" "}
            </p>
            <button className="btn btn-one">
              <Link to="/photography">Ver más</Link>
            </button>
          </div>
        </section>
      </article>
      ...
      <div className="position-btn">
        <button className="btn btn-one">
          <Link to="/mainService">Más detalles</Link>
        </button>
      </div>
    </fragment>
  );
